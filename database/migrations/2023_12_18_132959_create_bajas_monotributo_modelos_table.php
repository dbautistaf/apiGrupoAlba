...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tb_bajas_monotributo', function (Blueprint $table) {
            ...
            $table->string('codigo_posta', 8);
            $table->string('localidad', 50);
            $table->string('provincia', 30);
            $table->string('obra_social_elegida', 6);
    ...
    {
        Schema::dropIfExists('tb_bajas_monotributo');
    }
};
