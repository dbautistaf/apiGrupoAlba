...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tb_subsidio_sumarte', function (Blueprint $table) {
            $table->bigIncrements('id_subsidio_sumarte');
            $table->string('cod_obra_soc', 6);
            $table->string('periodo', 6);
            $table->string('cant_benef', 7);            
            $table->string('area_reser', 91);
            $table->decimal('subsidio_total', 15, 2);
            $table->string('periodo_subsidio_sumarte', 20);
    ...
    {
        Schema::dropIfExists('tb_subsidio_sumarte');
    }
};
