...
class TodoRecetasExport implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles
{
    /**
    ...
    public function collection()
    {
        ...
        $query = DB::table('tb_recetas')
            ...
            )->orderBy('tb_recetas.numero_receta')->get();
        /* ->whereBetween('tb_recetas.fecha_carga', [$this->desde, $this->hasta])  */
